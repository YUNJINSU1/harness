...
| 컨텍스트 압축 | OMP 내장 압축을 기본으로 사용하고 기존 native 상태의 portable 이전과 OMP 18.1.13~18.1.15 호환 패치를 제공합니다. |
...
유지하는 쇼케이스 대상은 **Bash와 GNU 호환 유틸리티를 갖춘 Linux 또는 WSL2, OMP 18.1.13~18.1.15, Bun 1.3.14**입니다. 설정 검사와 벤치마크에는 Python 3가 필요합니다. 현재 설치기는 기존 `~/.claude/CLAUDE.md`를 요구합니다. 기반 도구의 설치·인증은 별도로 준비합니다. 네이티브 Windows, macOS, 다른 OMP 버전, 다른 Bun 버전은 유지하는 호환 대상이 아닙니다.
